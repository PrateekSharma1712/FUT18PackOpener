...
public class PlayerCardView extends RelativeLayout {
    ...
    private SimpleDraweeView playerImage, clubImage, nationImage;
    ...
    private void setLayout(Context context) {
        View view = inflate(context, R.layout.player_card_layout, this);
    ...
    public void setValues(PackOpenerPlayer player) {
        playerImage.setImageURI(Uri.parse(player.getImage()));
        ...
        if (player.getPosition().equalsIgnoreCase("GK")) {
            pacLabel.setText("DIV");
            shoLabel.setText("HAN");
            pasLabel.setText("KIC");
            driLabel.setText("REF");
            defLabel.setText("SPD");
            phyLabel.setText("POS");
        }
